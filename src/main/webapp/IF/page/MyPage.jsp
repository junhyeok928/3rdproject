<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="DAO.User_Course_DAO" import="VO.User_Course_VO"%>
<%
		...
		<div>
			<div class="mymenubox1">
				<div class="mymenubox">
					<span>마이페이지</span>
					<ul class="mymenu">
						<li><a href="../page/MyPage.jsp" id="now">수강정보</a></li>
						<li><a href="../page/Cart.jsp">장바구니</a></li>
			...
			<div class="coursebox">
				...
				<table class="mycourse">
					...
					<tbody>
						...
						<tr>
							<td><%=vo.getComposeing()%>/<%=vo.getCompose()%>강
							</td>
							<td><%=(int) (((double) vo.getComposeing() / vo.getCompose()) * 100.0)%>%
							</td>
						</tr>
						<%
						}
