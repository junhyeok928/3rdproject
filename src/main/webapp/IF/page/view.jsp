...
<body>
	...
	if (boardID == 0) {
		...
		script.println("location.href = '../page/board.jsp'");
		script.println("</script>");
	}
	...
	<div class="container">
		...
		<div class="content">
			...
			<div style="margin-top: 30px;">
				<a href="../page/board.jsp" class="btn">목록</a>
				<%
				if (userID != null && userID.equals(board.getUserID())) {
				%>
				<a href="#?boardID=<%=boardID%>" class="btn2">수정</a> <a href="#?boardID=<%=boardID%>" class="btn2">삭제</a>
				<%
				}
				%>
			</div>
