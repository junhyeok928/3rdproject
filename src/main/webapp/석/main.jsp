		...
		<div class="menubox">
			<ul class="menu">
				...
				<li class="parent"><a href="#">커뮤니티</a>
					<ul class="submenu">
						<li class><a href="board.jsp">후기게시판</a></li>
						<li class><a href="board.jsp">자유게시판</a></li>
						<li class><a href="board.jsp">질문게시판</a></li>
					</ul></li>
	...
	<section>
			<div class="wrap">
				<ul>
					...
					<li class="tab_2"><a href="board.jsp">후기게시판</a></li>
					<li class="tab_2"><a href="board.jsp">질문게시판</a></li>
					<li class="tab_2"><a href="board.jsp">자유게시판</a></li>
				</ul>
				<%
