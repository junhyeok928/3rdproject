	...
	<div class="content">
			...
			<div id="content2">
				...
				<table style="border: 0px;">
					<%
					for (daily_VO d : dao.dailyList2()) {
					%>
					<tr>
						<td><%=d.getSysdate()%></td>
					</tr>
					<tr>
						<td width="300px"><%=d.getDaily_title()%></td>
					</tr>
					<tr>
						<td><%=d.getDaily_content()%></td>
					</tr>
					<tr>
						<td id="hidden2"><%=d.getDaily_answer()%></td>
					</tr>
					<%
					}
					%>
				</table>
				<input type="button" id="button2" value="정답확인" />
			</div>
